...
namespace RegistrationAndLogin.DatabaseDataSetTableAdapters {
...
SELECT Id, username, password FROM LoginTable WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::RegistrationAndLogin.Properties.Settings.Default.DatabaseConnectionString;
        }
